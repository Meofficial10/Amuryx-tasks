...
export function AuthLayout() {
  ...
  const [users, setUsers] = useState([]); // Store all registered users here
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-300 p-6">
      <div className="flex flex-col md:flex-row w-full max-w-5xl min-h-full bg-[#000042] rounded-xl shadow-2xl overflow-hidden pb-20 pt-20">
        {/* Left Side (Images) */}
        <div className="hidden md:flex flex-1 items-center justify-center relative">
           <img src={register ? loginImage : registerImage} alt="Security" className="h-auto z-10 w-[400px]" />
